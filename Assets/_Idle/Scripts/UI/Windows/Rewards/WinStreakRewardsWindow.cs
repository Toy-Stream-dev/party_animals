...
{
    public class WinStreakRewardsWindow : BaseSoundableWindow
    {
        ...
        private WinStreakRewardItem _reward;
        ...
        public void Open(WinStreakRewardItem reward)
        {
            _reward = reward;
            
            var rewards = _reward.Rewards;
